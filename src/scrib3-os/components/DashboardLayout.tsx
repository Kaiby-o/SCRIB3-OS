...
const DashboardInner: React.FC<{ role: UserRole }> = ({ role }) => {
  ...
  return (
    <div className="os-root">
      ...
      {/* ---- Empty Dashboard — widgets coming soon ---- */}
      <main style={{ paddingTop: 'calc(85px + 24px)', paddingLeft: '24px', paddingRight: '24px', paddingBottom: '140px', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'calc(100vh - 85px)' }}>
        <div className="flex flex-col items-center gap-4">
          <div style={{
            ...
            border: '2px dashed var(--border-default)', opacity: 0.2,
          ...
          <span style={{
            fontFamily: "'Owners Wide', sans-serif", fontSize: '14px',
            letterSpacing: '1px', textTransform: 'uppercase',
            opacity: 0.25, color: 'var(--text-primary)',
          }}>
            Add Widgets
          </span>
        </div>
