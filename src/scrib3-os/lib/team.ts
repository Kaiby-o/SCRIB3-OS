...
export const mockTeam: TeamMember[] = [
  ...
  },
  {
    ...
    avatarUrl: AVATAR_BASE + 'Ross_Booth.jpg',
  },
  {
    ...
    avatarUrl: AVATAR_BASE + 'Arthur_Stern.png',
  },
  {
    ...
    avatarUrl: AVATAR_BASE + 'Ishan_Bhaidani.png',
  },
  {
    id: 'tm-elena', name: 'Elena Zheng', email: 'elena@scrib3.co', role: 'team',
    title: 'VP of Accounts', unit: 'Accounts', location: 'USA', timezone: 'America/New_York',
    isOnline: true, availability: 'available',
  ...
  },
  {
    ...
    title: 'Operations', unit: 'Ops', location: 'USA', timezone: 'America/New_York',
    isOnline: true, availability: 'available',
  ...
  },
  {
    ...
    title: 'VP of PR', unit: 'PR', location: 'USA', timezone: 'America/New_York',
    isOnline: false, availability: 'offline', bio: '', skillsets: ['PR', 'Leadership', 'Content'],
  ...
  },
  {
    ...
    title: 'PR Account Manager', unit: 'PR', location: 'USA', timezone: 'America/New_York',
    isOnline: false, availability: 'offline', bio: '', skillsets: ['PR', 'Account Management'],
    socialLinks: [], currentClients: [], currentProjects: [],
  ...
  },
  {
    ...
    title: 'Senior PR Account Manager', unit: 'PR', location: 'Dubai', timezone: 'Asia/Dubai',
  ...
  },
  {
    ...
    title: 'Collaborator / Dev', unit: 'C-Suite', location: 'USA', timezone: 'America/New_York',
    isOnline: false, availability: 'away',
